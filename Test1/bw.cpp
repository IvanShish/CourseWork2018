...
bww::bww(QDialog* parent): QDialog(parent)
{
    ...
    connect(ok, SIGNAL(clicked()), this, SLOT(do_bw()));
}
...
void bww::do_bw()
{
    emit change_bw(coord_1x->value(), coord_1y->value(), coord_2x->value(), coord_2y->value());
}
